...
class Train_DQN:
    ...
    def optimize_model(self):
        ...
        non_final_next_states = np.array([s[2] for experience in batch if experience[2] is not None]).astype("float32") / 255.0
        ...
        non_final_mask = torch.tensor(np.array([s[2] is not None for experience in batch]), dtype=torch.bool)
