...
def main():
    ...
    parser.add_argument("save-checkpoint", help="save checkpoint every given episodes", default=50, type=int)
    ...
    Agent = Train_DQN(wrapped_env, height, width, batch_size, channel, device, memory, policy_net, target_net, gamma, optimizer, criterion, save_period)
