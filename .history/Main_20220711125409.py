...
def main():
    ...
    parser.add_argument("-save_checkpoint", help="save checkpoint every given episodes", default=50, type=int)
    ...
    Agent.learn(args.episodes, args.max_episode_steps, min_samples_for_training, train_period, update_target_net_steps, args.end_epsilion_decay)
